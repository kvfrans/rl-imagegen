...
class ActorNetwork(object):
    ...
    def create_actor_network(self, scope):
        ...
        #     h1 = tf.nn.relu(dense(inputs, self.s_dim, 400, "actor_h1"))
        #     h2 = tf.nn.relu(dense(h1, 400, 300, "actor_h2"))
        #     h3 = tf.nn.tanh(dense(h2, 300, self.a_dim, "actor_h3"))
        #     scaled = tf.mul(h3, self.action_bound)
        #     return inputs, h3, scaled
...
class CriticNetwork(object):
    ...
    def create_critic_network(self, scope):
        ...
        # with tf.variable_scope(scope):
        #     state_inputs = tf.placeholder(tf.float32, [None, self.s_dim])
        #     action_inputs = tf.placeholder(tf.float32, [None, self.a_dim])
        #
        #     s1 = tf.nn.relu(dense(state_inputs, self.s_dim, 400, "s1"))
        #     s2 = dense(s1, 400, 300, "s2")
        #     a1 = dense(action_inputs, self.a_dim, 300, "a1")
